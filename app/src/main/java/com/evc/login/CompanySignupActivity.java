...
public class CompanySignupActivity extends AppCompatActivity implements NetworkEventListener {
    ...
    private void init() {
        ...
        websiteText = (EditText) findViewById(R.id.input_website);
    ...
    public void signup() {
        ...
        progressDialog = new ProgressDialog(CompanySignupActivity.this,
        ...
        CompanyServiceTask companyServiceTask = null;
        companyServiceTask = new ServerCompanyRegisterTask();
        companyServiceTask.setNetworkEventListener(this);
        String[] taskParams = {name, website, email, phone, password};
        companyServiceTask.execute(taskParams);
    }
    ...
    public boolean validate() {
        ...
        if (website.isEmpty() || !Patterns.WEB_URL.matcher(website).matches()) {
            websiteText.setError("invalid web address");
            valid = false;
        } else {
