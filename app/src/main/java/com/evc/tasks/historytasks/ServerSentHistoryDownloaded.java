...
public class ServerSentHistoryDownloaded extends HistoryListService{
    ...
    protected void onPostExecute(List<HistoryEntry> historyEntries) {
        ...
        networkEventListener.onSentHistoryDownloaded(historyEntries);
    }

    @Override
    protected List<HistoryEntry> doInBackground(String... params) {

        url += "/histories/user/" + params[0];
